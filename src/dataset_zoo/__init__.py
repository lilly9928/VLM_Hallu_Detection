...
def get_dataset(dataset_name, image_preprocess=None, text_perturb_fn=None, image_perturb_fn=None, download=False,type=None, split=None, *args, **kwargs):
    """
    ...
    if dataset_name == "Controlled_Images_A":
        ...
        from .aro_datasets import get_pope
        return get_pope(image_preprocess=image_preprocess, text_perturb_fn=text_perturb_fn, image_perturb_fn=image_perturb_fn, type = type,split=split, *args, **kwargs)
